    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6">
                ...
                <img src="{{ asset('\images\register.jpg') }}" alt="" style="width: 200px">
            </div>
            <div class="col-md-6">
                <div class="card" id="card">
                    <div class="card-header">Register employeer</div>
                    <form action="#" method="POST" id="registrationForm">
                        <div class="card-body" >
                            ...
                            <br>
                            <div class="form-group">
                                <button class="btn btn-primary" id="btnRegister">sumbit</button>
                            </div>
                        </div>
                    </form>
                </div>
